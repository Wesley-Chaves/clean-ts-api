...
import { LoadAccountByEmailRepository, UpdateAccessTokenRepository, TokenGenerator, HashComparer } from './db-authentication-protocols'
...
const makeHashComparer = (): HashComparer => {
  class HashComparerStub implements HashComparer {
    async compare (password: string, hashToCompare: string): Promise<boolean> {
...
describe('DbAuthentication Usecase', () => {
  ...
  test('Should throw if LoudAccountByEmailRepository throws', async () => {
    const { sut, loadAccountByEmailRepositoryStub } = makeSut()
